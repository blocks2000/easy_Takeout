...
<%
	IMenuService menuService=new IMenuServiceImpl();
 	...
 	if(shop==null) trueShopName=shopName2;
 	else
 	{
 		shopName=shop.getShopname();
 		trueShopName=shopName;
 	}
 	List<FoodMenu> menus=menuService.queryMenuByShopName(trueShopName);
 %>
<ul>
	<li><a href="#">查看店铺信息</a></li>
	<li><a href="queryAllMenuServlet?shopname=<%=trueShopName%>">查看店铺菜品</a></li>
	<li><a href="queryMerchantServlet?shopname=<%=trueShopName%>">查看店铺订单</a></li>
